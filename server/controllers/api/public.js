...
exports.add = (req, res, next) => {
    ...
    if (form.nome.length > 0 && form.nome.length > 0 && form.tipo.length > 0 && form.marca.length > 0 && form.cor.length > 0 && form.altura.length > 0 && form.foto.length > 0 && form.endereco) {
        new Televisao({
                ...form
            })
            .save()
...
exports.edit = (req, res, next) => {
    ...
    Televisao
        ...
        .then(televisao => {
            ...
            televisao.endereco = req.body.endereco;
            televisao.save();
